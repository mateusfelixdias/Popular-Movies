export default function App() {
  return (
      <main className="w-[100%]">
        ...
        <h1 className="text-4xl text-[#f1f5f9] pb-8">Filmes Populares</h1>
        ...
        <div className="text-zinc-900 flex items-center justify-between gap-[8px] bg-[#1D1C3B] rounded-lg p-[4px] m-0 m-auto mb-[8px] w-[100%] shadow-2xl">
            <div className="flex items-center gap-4">
              <img className="w-[92px] h-[92px] mr-4 rounded-lg" src="./src/image/batman.svg" alt="image batman" />
            ...
            <div className="whitespace-normal w-[100%] ml-20 text-zinc-100">
        ...
        <div className="text-zinc-900 flex items-center justify-between gap-[8px] bg-[#1D1C3B] rounded-lg p-[4px] m-0 m-auto mb-[8px] w-[100%] shadow-2xl mt-8">
            <div className="flex items-center gap-4">
              <img className="w-[92px] h-[92px] mr-4 rounded-lg" src="./src/image/avatar.svg" alt="image batman" />
              <div className="flex flex-col items-center text-zinc-100">
        ...
        <div className="text-zinc-900 flex items-center justify-between gap-[8px] bg-[#1D1C3B] rounded-lg p-[4px] m-0 m-auto mb-[8px] w-[100%] shadow-2xl mt-8">
            <div className="flex items-center gap-4">
              <img className="w-[92px] h-[92px] mr-4 rounded-lg" src="./src/image/vigadores.svg" alt="image batman" />
              <div className="flex flex-col items-center text-zinc-100">
        ...
        <div className="text-zinc-900 flex items-center justify-between gap-[8px] bg-[#1D1C3B] rounded-lg p-[4px] m-0 m-auto mb-[8px] w-[100%] shadow-2xl mt-8">
            <div className="flex items-center gap-4">
              <img className="w-[92px] h-[92px] mr-4 rounded-lg" src="./src/image/vigadoresUltimato.svg" alt="image batman" />
              <div className="flex flex-col items-center text-zinc-100">
